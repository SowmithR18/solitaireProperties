export const PropertyManagement = () => (
  <section className="m-10 px-4 md:px-64 flex flex-col items-center my-20">
    ...
    <section className="flex flex-col md:flex-row mt-8">
      <div className="flex flex-col items-center w-96 rounded-xl bg-[#F2F7FF] mt-6 md:mt-0 md:mr-6">
